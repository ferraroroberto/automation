...
See `AGENTS.md#tldr` for core standards and `AGENTS_STRUCTURE.md#reorg-checklist` for structure guidance.
...
> For project structure reorganization guidance, see `AGENTS_STRUCTURE.md#reorg-checklist`.
