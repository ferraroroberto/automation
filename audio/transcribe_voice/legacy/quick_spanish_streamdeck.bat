@echo off
REM Quick Spanish Transcription Launcher for Stream Deck
...
title "Spanish Transcription (PRESS ANY KEY TO STOP)"
mode con: cols=80 lines=25
powershell -command "$wshell = New-Object -ComObject wscript.shell; $wshell.AppActivate('Spanish Transcription')"

cls
echo ===========================================
echo SPANISH VOICE TRANSCRIPTION
echo ===========================================
echo.
echo Instructions:
